...
<s:hidden id="ts" value="%{getText('prompt.ts')}"/>
<s:hidden id="alert6" value="%{getText('login.alert6')}"/>
<s:hidden id="alert5" value="%{getText('login.alert5')}"/>
<s:hidden id="alert4" value="%{getText('login.alert4')}"/>
...
<s:hidden id="qrcodeImgButton" value="%{getText('login.qrcodeImg')}"/>
<s:hidden id="alert33" value="%{getText('prompt.alert33')}"/>
	<!--<div style="margin-left:500px;"><a href="javascript:changeLanguage('zh');" style="font-size:1.5em;color:blue;">中文</a>丨<a href="javascript:changeLanguage('en');" style="font-size:1.5em;color:blue;">EN</a></d>-->
  ...
  <tr>
    ...
    <table width="629" id="tab1" border="0" cellpadding="0" cellspacing="0">
	    <td height="72" colspan="6" style="padding-left:150px;padding-top:150px;"><table width="100%"  border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td>&nbsp;<span style="position: relative;top: -83px;left: 200px; "><a href="javascript:changeLanguage('zh');" style="font-size:1.3em;color:blue;">中文</a>丨<a href="javascript:changeLanguage('en');" style="font-size:1.3em;color:blue;">EN</a></span></td>
          </tr>
		  <tr align="left" valign="bottom">
			...
			<td rowspan="5"><img id ="qrcodeImg" width="128" title="校内师生（含已退休人员、新生）登录，使用jAccount账号登录，若无jAccount账号，点击进入后可创建jAccount账号"></td>
		  </tr>
		  <tr>
            <td>&nbsp;</td>
          </tr>
	...
	<table width="629" id="tab2" border="0" cellpadding="0" cellspacing="0" style="display:none; ">
      ...
      <tr>
        ...
        <td align="left" rowspan="2"><a href="javascript:register();" style = "font-size:1.2em;">【<s:text name="login.registername"/>】</a></td>
      ...
      <tr>
		...
		<td rowspan="2" align="left"><a href="javascript:resetPwd();" style = "font-size:1.2em;">【<s:text name="login.resetpassword"/>】</a></td>
		</tr>
      <tr>
        <td>&nbsp;</td>
        <td colspan="2">&nbsp;</td>
